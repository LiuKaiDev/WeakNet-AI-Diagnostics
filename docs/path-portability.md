...
将项目中的固定绝对路径改为相对路径，确保项目可以在不同目录下编译和运行。
...
- **eBPF对象文件**: `server/build/flow_rate.bpf.o` (相对路径)
...
- `docs/events.md`: 更新事件系统使用路径

#### 新增文档
- `docs/project-notes.md`: 项目使用说明归档
- `docs/path-portability.md`: 本路径整理说明
